...
public class Post {
     ...
     */
    public void addLike(Like tempLike,ArrayList<Account> accounts,Account owner)
    {
        String like_History;
        int likeIdControl=0;
    ...
    public void unLike(Like tempLike,ArrayList<Account> accounts,Account owner)
    {
     ...
     */
    public void addComment(Comment tempComment,ArrayList<Account> accounts,Account owner)
    {
    ...
    public void unComment(Comment tempComment,ArrayList<Account> accounts,Account owner)
    {
