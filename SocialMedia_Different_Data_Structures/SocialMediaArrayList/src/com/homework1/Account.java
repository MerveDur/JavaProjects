...
public class Account {
     ...
     * The Array of posts
     */
    private ArrayList<Post> posts = new ArrayList<Post>(); // works fine
    /**
     ...
     */
    private ArrayList<Account> blockedAccounts = new ArrayList<Account>();
    /**
    ...
    */
    public Account(ArrayList<Account> accounts,int accontSize,int accountid, String username, String birthdate, String location, boolean loginStatus)
    {
     ...
     */
    public void setFollowing(ArrayList<Account> following,int newFollowingSize)
    {
     ...
     */
    public void setFollowers(ArrayList<Account> followers, int newFollowerSize)
    {
     ...
     */
    public  void viewingInbox(ArrayList<Account> senderList,int senderListSize)
    {
        if(this.loginStatus==true)//Checking that the account is logged in
        {
     ...
     * @param senderListSize  An int containing a sender list size
     */
    public  void viewingOutbox(ArrayList<Account> senderList,int senderListSize)
    {
        if(this.loginStatus==true)//Checking that the account is logged in
        {
     ...
     */
    public void  viewingPostsInteractions(Account tempAccount,ArrayList<Account> senderList,int senderListSize)
    {
        int commentOrder=1;
    ...
    {// Increase the size of the block array and add the new block account
        ...
        ArrayList<Account> newfollowers = new ArrayList<Account>();
        ArrayList<Account> newfollowing = new ArrayList<Account>();
        int j=0;
        try
        {
            if (this.isLoginStatus() == true)//Checking that the account is logged in
