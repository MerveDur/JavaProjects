...
public class Post {
     ...
     */
    public void addLike(Like tempLike,LDLinkedList<Account> accounts,Account owner)
    {
        String like_History;
        int likeIdControl=0;
    ...
    public void unLike(Like tempLike,LDLinkedList<Account> accounts,Account owner)
    {
        String unlike_History;
        try
        {
            if(this.likes.contains(tempLike))
            {
                this.likes.remove(tempLike);
               // this.likesSize--;
                for (int i = 0; i < accounts.size(); i++)
                {
                    if (accounts.get(i).getAccountid()==this.getAccountId())
     ...
     */
    public void addComment(Comment tempComment,LDLinkedList<Account> accounts,Account owner)
    {
    ...
    public void unComment(Comment tempComment,LDLinkedList<Account> accounts,Account owner)
    {
        ...
        try
        {
            ...
            {
                this.comments.remove(tempComment);
              //  this.commentsSize--;
                for (int i = 0; i < accounts.size(); i++)
                {
                    if (accounts.get(i).getAccountid()==this.getAccountId())
