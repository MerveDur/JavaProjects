...
public class TestClass1 {
    public static void main(String[] args) {
       ...
       // gokhankaya.addPost(post1); // control
        ...
        post1.addLike(like1,accounts,gokhankaya);
        ...
        post1.addComment(comment1,accounts,gokhankaya);
        ...
        post1.addLike(like2,accounts,gizemsungu);
        Like like3=new Like(3,gizemsungu.getAccountid(),post2.getPostId());
        post2.addLike(like3,accounts,gizemsungu);
     ...
     */
    public static int isMember(LDLinkedList<Account> accounts, Account member)
    {
        int findValue=0;
